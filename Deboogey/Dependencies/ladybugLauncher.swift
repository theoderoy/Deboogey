...
enum ladybugLauncherError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .invalidArguments(let userFacing, _):
            return userFacing
        case .toolNotFound:
            return L10n.t("deboogeyLadybugHelper not found at Contents/Resources within the app bundle.")
        ...
        case .toolNotExecutable(let path):
            return L10n.f("deboogeyLadybugHelper exists but is not executable. (path: %@)", path)
